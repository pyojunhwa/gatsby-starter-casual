      ...
      <div className="product-item">
        ...
        <div className="intro">
          <div className="intro-text-anfahrt d-flex mr-auto">
            <div className="bg-transparent p-5 d-flex ml-auto rounded">
              <img className="intro-wappen-klein" src={wappen} alt="" />
            </div>
          </div>
        </div>
        <a href="https://goo.gl/maps/2UiVKqYf2Af3AGHv6" target="_blank" rel="noopener noreferrer">
          <img
        ...
        <div className="product-item-description d-flex mr-auto">
          <div className="bg-faded p-5 rounded">
            <a style={{ textDecoration: "none", color: "#000000" }} href="https://goo.gl/maps/2UiVKqYf2Af3AGHv6" target="_blank" rel="noopener noreferrer" className="mb-0">
              <span style={{ color: "blue" }}>Das Bild ist ein Link zu Google Maps</span>
            </a>
          </div>
        </div>
      </div>
